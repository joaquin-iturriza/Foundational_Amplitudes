...
# STEPS= sets the horizon (default 1000) and VF= the validation fraction (default 0.05).
set -euo pipefail
...
python run.py \
  ...
  training.iterations="${STEPS:-1000}" training.batchsize=16384 evaluation.batchsize=16384 \
