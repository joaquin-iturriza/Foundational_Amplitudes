...
what $\sigma$-steering can exploit. The $\gamma$ sweep separates the two regimes cleanly: on a concentrated
...
\begin{itemize}
  ...
  \item \textbf{Massive final states} (the remaining harder-divergence case; the multi-scale $u\bar u g$
    ...
    $s_{ij}/s$, identical for massless legs), and the standalone slot-order check. \emph{Still genuinely
    open:} the run itself, and a single process carrying soft$+$collinear$+$resonant coverage at once.
