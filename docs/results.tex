...
$=90\%,70\%,66\%,62\%,\mathbf{55\%}$ --- the deep-IR error is nearly \emph{halved} at $\gamma{=}10$ and
still falling. The overall metric saturates because the reallocation has a real cost: the shallowest
...
\begin{figure}[H]
  ...
  ($y_{\min}\!<\!10^{-6}$) falls monotonically --- $90,70,66,62,\mathbf{55}\%$ of base --- while the
  shallowest bulk decade \emph{rises} $107\!\to\!128\%$. So the log-flat average saturates around
  $\gamma\!\approx\!3$--$5$ and larger $\gamma$ buys deep-IR accuracy by paying in the bulk: one
  coordinate-free scalar knob sliding along the allocation trade-off of Thread~B.}
...
what $\sigma$-steering can exploit.
\end{principle}
