...
suggests. Figures: \code{q2\_confirm}, \code{q2\_dense}, \code{q2\_rankmag}, \code{q2\_logflat}.
...
\code{finetune\_genmix.sh}, \code{plot\_genmix\_sweep.py} (fig \code{eeuu\_genmix\_fraction\_sweep}).
...
session, which are retracted.) Figures: \code{l2\_uugg\_perdecade} (base vs $\sigma$ at $\gamma{=}1$),
\code{l2\_uugg\_gamma} (per-decade ratio + the deep-vs-bulk trade-off vs $\gamma$),
\code{l2\_uugg\_perdecade\_abs} (absolute MSE per decade, all $\gamma$).
