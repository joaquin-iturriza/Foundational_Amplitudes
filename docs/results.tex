...
\paragraph{Follow-ups.} A deeper-sampling variant: regenerate $u\bar u g$ with tighter
\code{ptj}/\code{drjj} fiducial cuts to probe below the current IR cutoff
(\code{mg5\_pipeline\_final}), and extend the soft/collinear split to $u\bar u gg$.
