...
#SBATCH --array=0-8
#SBATCH --output=analysis/divergences/ft_l1raw_%A_%a.out
#SBATCH --error=analysis/divergences/ft_l1raw_%A_%a.out
set -e
...
# L1 on a STARVED (RAMBO) base, 3 seeds x {base,sigma,oracle}. Coverage is capped (pool pole=0.44%),
# so sigma-emphasis should help HERE if it ever does.
