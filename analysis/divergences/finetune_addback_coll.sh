...
#SBATCH --array=0-3
#SBATCH --output=analysis/divergences/ft_coll_ho_%A_%a.out
#SBATCH --error=analysis/divergences/ft_coll_ho_%A_%a.out
...
DATA_PATH=$REPO/data_ho_coll_f${TAG}/

python run.py \
  exp_name=pretrain22_heldout_uug run_name=ft_coll_f${TAG} \
