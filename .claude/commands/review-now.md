...
each subagent it is reviewing an accumulated backlog, not a single change, and that on a pass
it clears its own watermark via `review_backlog.sh advance <name>`.
